...
> **Note**
> 本プロジェクトの開発はここで一区切りとなります。
>
> 大規模なリアーキテクチャを予定しているため、この形での開発は終了します。
>
> Hikarinoは、個人開発で躓きがちなポイントや、最初から考慮すべきことを数多く教えてくれたプロジェクトでした。環境変数の管理、認証フローの設計、決済システムの統合、モノレポ構成への移行など、実践を通じて得られた学びは次のプロジェクトに活かしていきます。
>
