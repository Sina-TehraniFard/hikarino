    ...
    <div className="mt-6 mb-12">
      ...
      {!flippedCards.every((flipped) => flipped) && (
        <div className="mb-6 text-center transition-all duration-500 ease-in-out">
          <Button onClick={handleFlipAll} variant="secondary" size="medium">
      ...
      <div className="relative w-screen -ml-6 md:-ml-0 md:w-full overflow-hidden">
        ...
        <div className="tarot-scroll-container flex gap-3 md:gap-4 overflow-x-auto scrollbar-hide touch-pan-x snap-x snap-mandatory pb-4 pl-6 md:pl-0">
          {/* 左端の余白 */}
